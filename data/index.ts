...
export const gridItems = [
    {
        ...
        subtitle: "React · Next.js · TypeScript Developer",
        description:
            "Frontend-first engineer from Bangladesh who turns ideas into fast, polished web experiences — with clean code, smooth UX and products that feel right.",
        badge: "Open to work",
    ...
    },
    {
        ...
        description: "Based in Dhaka (UTC+6)",
    ...
    },
    {
        id: 3,
        title: "My toolkit",
        description: "Technologies I reach for every day",
        className: "lg:col-span-2 md:col-span-3 md:row-span-2",
        imgClassName: "",
    ...
    },
    {
        ...
        description: "A collaboration-first mindset",
        className: "lg:col-span-2 md:col-span-3 md:row-span-1",
        imgClassName: "",
        titleClassName: "justify-start",
        img: "/grid.svg",
        spareImg: "",
        chips: ["Clean & scalable code", "Mobile-first UX", "Clear communication", "Ownership & grit"],
    },
    {
        id: 5,
        title: "Currently leveling up my animation skills",
        description: "The Inside Scoop",
        subtitle: "GSAP · Three.js · WebGL",
    ...
    },
    {
        ...
        description: "Have an idea? I'm one email away.",
        className: "lg:col-span-2 md:col-span-3 md:row-span-1",
        imgClassName: "",
...
export const projects = [
    ...
    {
        id: 2,
        title: "XTREME- a summer camp for kids",
        des: "Experience the ultimate summer adventure at our camp, where fun, learning, and friendship come together in the great outdoors!",
        img: "https://i.ibb.co/R7Dq1yZ/Screen-Shot-2024-06-25-at-17-51-05.png",
        iconLists: ["/re.svg", "/tail.svg", "/js.svg", "/Firebase_icon.svg.svg", "/fm.svg", '/mono.svg'],
        link: "/ui.yoom.com",
    },
    {
        id: 3,
        title: "Brainwave a modern web design",
        des: "A REAL Software-as-a-Service app with AI features.",
        img: "https://i.ibb.co/j9t24jk/Screen-Shot-2024-06-25-at-17-43-32.png",
        iconLists: ["/re.svg", "/tail.svg", "/js.svg",],
        link: "https://brainwave-eight-pearl.vercel.app/",
    },
    {
        id: 4,
        title: "Animated Apple Iphone 3D Website",
        des: "Recreated the Apple iPhone 15 Pro website, combining GSAP animations and Three.js 3D effects..",
        img: "https://i.ibb.co/7KZQJm6/Screen-Shot-2024-06-25-at-17-56-01.png",
        iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/three.svg", "/gsap.svg"],
        link: "https://iphone-15-pro-clone-three.vercel.app/",
    },
];
...
export const socialMedia = [
    {
        id: 1,
        img: "/git.svg",
        link: 'https://github.com/SAIKAT-ROY-CHANDAN'
    },
    {
        id: 2,
        img: "/twit.svg",
        link: 'https://x.com/SaikotRC'
    },
    {
        id: 3,
        img: "/link.svg",
